...
def stitching(addresses, threshold1, threshold2, detectorType = 'brisk'):
    ...
    matchesIm = cv.drawMatches(image1, kp1, image2, kp2, matches[:10], None, flags=cv.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
    ...
    (H, status) = cv.findHomography(pts2, pts1, cv.RANSAC, 4)
    print(H)
